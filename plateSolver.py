"""
Acknowledgement:
This implementation adapts the open-source
tetra3 star identification algorithm developed by the European Space Agency (ESA),
originally based on the Tetra algorithm by Brown et al.
"""
# Standard imports:
...
class Tetra3():
    ...
    def solve_from_centroids(self, star_centroids, size, fov_estimate=None, fov_max_error=None,
        ...
        for image_pattern_indices in itertools.combinations(
            ...
            # could correspond to.
            pattlen = int(
                math.factorial(p_size) /
                (2 * math.factorial(p_size - 2)) - 1
            )
